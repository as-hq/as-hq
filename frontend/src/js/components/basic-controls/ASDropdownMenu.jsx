...
const ASDropDownMenu = React.createClass({
  ...
  propTypes: {
    ...
    /**
     * **DEPRECATED** `ASDropDownMenu` will use this member to display
    ...
    /**
     * Overrides the styles of label when the `ASDropDownMenu` is inactive.
     */
    ...
    /**
     * Overrides the styles of `Menu` when the `ASDropDownMenu` is displayed.
     */
    ...
    /**
     * Set to true to have the `ASDropDownMenu` automatically open on mount.
     */
    ...
    /**
     * **DEPRECATED** `ASDropDownMenu` will use this member as the value representing an item.
     */
