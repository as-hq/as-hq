...
import ShortcutHelperStore from '../../stores/ShortcutHelperStore';
...
export default class ShortcutHelper extends React.Component<{}, {}, {}> {
  ...
  componentDidMount() {
    Util.React.addStoreLinks(this, [{ store: ShortcutHelperStore }]);
  }
  ...
  _onRequestClose() {
    ShortcutHelperActionCreator.closeShortcutHelper();
  }
  ...
  render(): React.Element {
    const display = ShortcutHelperStore.isOpen() ? 'block' : 'none';
    return (
    	<div style={{display}}>
	  		<AppBar
	  			style={styles.appBar}
