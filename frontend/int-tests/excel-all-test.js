...
describe('excel', () => {
  ...
  beforeEach((done) => {
    _do([
      logP('Clearing sheet...'),
      clear(), // every xit() starts with a clear spreadsheet
