describe('excelfunctions', () => {
  ...
  it ('HEX2BIN', (done) => {
      _do([
          ...
          shouldBe('A2', valueI(00001111)),
          shouldBe('A3', valueI(10110111)),
          shouldBe('A4', valueI(1111111111)),
  ...
  it ('BASE', (done) => {
      _do([
          ...
          shouldBe('A2', valueI(111)),
          shouldBe('A4', valueI(64)),
          shouldBe('A6', valueI(0000001111)),
